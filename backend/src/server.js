...
const { handleInsertImage, handleGetPlayerData } = require('./game/gameHandlers');
...
io.on('connection', (socket) => {
  ...
  socket.on('getPlayerData', (roomCode, id, callback) => { handleGetPlayerData(roomCode, id, callback, socket) });
